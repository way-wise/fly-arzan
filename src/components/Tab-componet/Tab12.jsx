    ...
    <div className="Dashboard-Tab-box">
      <Tabs>
        ...
        <div className="Dashboard-Tab-body">
          <TabPanel>
            <div className="Dashboard-Schedule-box">
              <BookingCalendar />
              <div className="Dashboard-itex-card-box">
            ...
            <div className="Dashboard-Reservation-box">
              <div className="Reservation-Stats-box">
                <div className="Reservation-Stats-box-tital">
                  <h2>Reservation Stats</h2>
                </div>
                <StyledChart />
              </div>

              <div className="Recent-Bookings-box">
                <TableComponent />
              </div>
            </div>
          </TabPanel>
