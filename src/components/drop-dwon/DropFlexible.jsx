...
const DropFlexible = ({ isOpen, onToggle }) => {
  const { t } = useTranslation();
  const [selectedOption, setSelectedOption] = useState(t("CarfilterSections.transmissionType.select"));

  const options = Object.values(t("CarfilterSections.transmissionType.options", { returnObjects: true }));
