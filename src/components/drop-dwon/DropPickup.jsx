...
const DropPickup = ({ value }) => {

  const [isOpen, setIsOpen] = useState(false);
  const [selectedOption, setSelectedOption] = useState("pickup_time");
  ...
  const getTime = () => {
    return new Date().toISOString().split("T")[1].split("Z")[0]; // Extracts HH:mm:ss
  };
