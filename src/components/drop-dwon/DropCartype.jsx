...
const DropCartype = ({ isOpen, onToggle }) => {
  const { t } = useTranslation();
  const [selectedOption, setSelectedOption] = useState(t("CarfilterSections.carType.select"));

  const options = Object.values(t("CarfilterSections.carType.options", { returnObjects: true }));
