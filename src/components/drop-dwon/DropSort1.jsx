...
const DropSort1 = ({ isOpen, onToggle }) => {
  const { t } = useTranslation();
  const [selectedOption, setSelectedOption] = useState(t("CarfilterSections.sortBy.select"));
  // const [isOpen, setIsOpen] = useState(false);

  const options = [
    t("CarfilterSections.sortBy.suggested"),
    t("CarfilterSections.sortBy.cheapest")
  ];
