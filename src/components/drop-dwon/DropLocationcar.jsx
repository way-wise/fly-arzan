...
const DropLocationcar = ({ isOpen, onToggle }) => {
  const { t } = useTranslation();
  const [selectedOption, setSelectedOption] = useState(t("CarfilterSections.location.select"));
//   const [isOpen, setIsOpen] = useState(false);

  const options = Object.values(t("CarfilterSections.location.options", { returnObjects: true }));
...
export default DropLocationcar;
