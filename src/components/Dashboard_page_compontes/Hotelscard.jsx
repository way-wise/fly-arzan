  ...
  return (
    <>
      <div className="Sec2-card-box">
        {cardData.map((card) => (
          <div className="Sec2-card add-with" key={card.id}>
                ...
                <div className="Sec2-card-item">
                  <svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" viewBox="0 0 19 19" fill="none">
                    <g clipPath="url(#clip0_93_1707)">
                      <path d="M15.637 12.9034H11.3544V7.24426H13.1695C13.1489 5.70023 12.8593 4.12895 12.3675 2.90741C11.914 1.78086 11.3233 1.08105 10.826 1.08105C10.3288 1.08105 9.7381 1.78086 9.28455 2.90741C8.7928 4.12891 8.50317 5.70023 8.48257 7.24426H10.2977V12.9034H6.90199L5.35106 11.3525C4.23938 10.2408 2.4306 10.2408 1.31895 11.3525C1.21987 11.4516 1.16418 11.5859 1.16418 11.726C1.16418 11.8661 1.21987 12.0006 1.31895 12.0996L5.13621 15.9169C5.12822 15.9369 5.12096 15.9573 5.11529 15.9787L4.74128 17.3944C4.66675 17.6764 4.83504 17.9656 5.11712 18.0401C5.16235 18.052 5.20775 18.0577 5.25241 18.0577C5.48638 18.0577 5.70028 17.9011 5.76287 17.6642L6.12783 16.2828H16.3331V17.5293C16.3331 17.8211 16.5697 18.0576 16.8615 18.0576C17.1532 18.0576 17.3898 17.8211 17.3898 17.5293V16.2828H17.9598C18.2516 16.2828 18.4881 16.0463 18.4881 15.7545C18.4882 14.1824 17.2091 12.9034 15.637 12.9034Z" fill="#272727" />
                      <path d="M13.3477 2.51279C13.8879 3.85439 14.2054 5.56942 14.2263 7.24425H16.9893C17.281 7.24425 17.5176 7.0077 17.5176 6.71593C17.5176 3.02624 14.5158 0.0244141 10.826 0.0244141C11.8061 0.0244141 12.7017 0.908147 13.3477 2.51279Z" fill="#272727" />
                      <path d="M8.30432 2.51279C8.95039 0.908147 9.84592 0.0244141 10.826 0.0244141C7.13625 0.0244141 4.13446 3.02624 4.13446 6.71593C4.13446 7.0077 4.37101 7.24425 4.66278 7.24425H7.42577C7.44669 5.56945 7.76421 3.85443 8.30432 2.51279Z" fill="#272727" />
                    </g>
                    <defs>
                      <clipPath id="clip0_93_1707">
                        <rect width="18.0334" height="18.0334" fill="white" transform="translate(0.809448 0.0244141)" />
                      </clipPath>
                    </defs>
                  </svg>
                  <p>{card.icon1}</p>
